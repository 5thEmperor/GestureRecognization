...
def face():
    ...
    facedetect=cv2.CascadeClassifier(r'C:\Users\HP\Downloads\ai_pro\face\haarcascade_frontalface_default.xml')
    pygame.init()
    ...
    img=pygame.image.load(r'C:\Users\HP\Downloads\ai_pro\face\img.jpg').convert()
